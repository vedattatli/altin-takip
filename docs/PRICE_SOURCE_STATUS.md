...
Yani **şu an tek bir ürün canlı fiyatla değerlenmektedir: Gremse Altın.**
Çeyrek, Yarım ve Tam için yöneticinin `/yonetim/deneysel-kaynak` ekranından
onay vermesi gerekir; onaya kadar bu ürünler "fiyat alınamıyor" uyarısı gösterir.

### Bilerek çözülmeyen satırlar

| Ekran etiketi | Neden |
| --- | --- |
| ATA - REŞAT LİRA | Tek satırda iki farklı ürün var; hangisinin fiyatı olduğu belirsiz |
| ATA - REŞAT BEŞLİ | Aynı neden |
